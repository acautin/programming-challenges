...
- [Javascript implementation](codingame/contests/platinumRift.js)
- [Go implementation](codingame/contests/platinumRift.go)
...
- [Javascript implementation](codingame/contests/backToThecode.js)
...
- [Ruby implementation](codingame/contests/codeVsZombies.rb)
...
- [Rust implementation](codingame/contests/hypersonic.rs)
...
- [Rust implementation](codingame/contests/theAccountant/src/main.rs)
...
- [Rust implementation](codingame/contests/ghostInTheCell.rs)
...
- [Rust implementation](codingame/contests/codersOfTheCaribbean/main.rs)

### Code4Life

Produce medicines and maximize your score by transporting items across a medical complex. 

- [Rust implementation](codingame/contests/Code4Life.rs)

### Wondev Woman

The game is played on a square grid of a given size. Both players start with two units placed randomly on the grid.
Both players take it in turns to perform one action with one of their units. To score points, players must get a unit to climb up cells and reach a height of 3 levels.
...
- [Go implementation](codingame/puzzles/powerOfThor/powerOfThor.go)
- [Go code golf](codingame/puzzles/powerOfThor/powerOfThor_code_golf.go)
- [Javascript code golf](codingame/puzzles/powerOfThor/powerOfThor_code_golf.js)

### The Descent

Find the highest mountain out of a list of mountains.

- [Go implementation](codingame/puzzles/theDescent.go)

### Temperatures

Your program must analyze records of temperatures to find the closest to zero.

- [cpp implementation](codingame/puzzles/temperatures/temperatures.cpp)
- [cpp code golf](codingame/puzzles/temperatures/temperatures_code_golf.cpp)
- [Javascript code golf](codingame/puzzles/temperatures/temperatures_code_golf.js)

### Mars Lander - Episode 1

Land the spaceship on the platform. (Only vertically movement involved)

- [C# implementation](codingame/puzzles/marsLander/marsLander1.cs)
- [Clojure implementation](codingame/puzzles/marsLander/marsLander1.cs)
...
- [Python implementation](codingame/puzzles/horseRacingDuals/horseRacingDuals.py)
- [Bash implementation](codingame/puzzles/horseRacingDuals/horseRacingDuals.sh)
...
- [C implementation](codingame/puzzles/asciiArt.c)
...
- [Python implementation](codingame/puzzles/apuInitPhase.py)
...
- [cpp implementation](codingame/puzzles/heatDetector.cpp)
...
- [Haskell implementation](codingame/puzzles/skynet/skynetVirus.hs)
...
- [cpp implementation](codingame/puzzles/dontPanic/dontPanic1.cpp)
- [cpp code golf](codingame/puzzles/dontPanic/dontPanic1_code_golf.cpp)
- [rust implementation](codingame/puzzles/dontPanic/dontPanic1.rs)
- [rust code golf](codingame/puzzles/dontPanic/dontPanic1_code_golf.rs)
- [Javascript implementation](codingame/puzzles/dontPanic/dontPanic1.js)
- [Javascript code golf](codingame/puzzles/dontPanic/dontPanic1_code_golf.js)
...
- [cpp implementation](codingame/puzzles/stockExchangeLoss.cpp)

### War

Your program must determine the winner of a game of War, a simple two-player card game.

- [cpp implementation](codingame/puzzles/winamax.cpp)
...
- [cpp implementation](codingame/puzzles/conwaySequence/conwaySequence.cpp)
- [Erlang implementation](codingame/puzzles/conwaySequence/conway_sequence.erl)
...
- [Ruby implementation](codingame/puzzles/marsLander/marsLander2.rb)
